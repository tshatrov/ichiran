...
;;(def-simple-split split-nimo 1009610
...
(defparameter *hints-checked*
  (mapcar 'car
          '(
            ...
            (2860289 "首をはねる") (1614040 "割ってはいる") (1639300 "世界のはて") (2849161 "はにゅうの宿")
            (2859753 "はだしで逃げる") (2859754 "はだしで逃げ出す") (2859754 "はだしで逃げだす")
            (2859776 "根がはえる") (2102020 "足をはこぶ") (2102630 "思いをはらす") (2102630 "思いをはらす")
            (2239210 "はなで笑う") (2862603 "話がはずむ") (2863695 "化けの皮がはがれる") (2863695 "ばけの皮がはがれる")
            (1858020 "息をはく") (1893350 "地のはて") (2213430 "とりはだが立つ") (2628190 "雪のはて") (2864291 "気合がはいる")
            (2868374 "片意地をはる") (1586300 "挙句のはて")
            ...
            (2756140 "有らへん") (2756140 "在らへん") (2864371 "小腹がへる")
            )))
...
(def-simple-hint
    (
     2867144 ;; "二目の頭は見ずハネよ" why is this sentence even in jmdict, smh
     2867149 ;; "死はハネにあり" another Go sentence...
     )
    (l k)
  (ha (search "は" k))
  (:space ha)
...
(def-easy-hint 2861000 "今 は 亡き")
(def-easy-hint 2861001 "今 は 無き")
(def-easy-hint 2861231 "言って は なんです が")
(def-easy-hint 2862670 "夫婦 は 合わせ鏡")
(def-easy-hint 2863444 "然 は 然りながら")
(def-easy-hint 2863557 "人生 は 一度きり")
(def-easy-hint 2865369 "世間 は 張り物")
(def-easy-hint 2867221 "武士 は 相身互い")
(def-easy-hint 2868635 "止まない 雨 は ない")
(def-easy-hint 2864666 "予定 は 未定")
(def-easy-hint 2865149 "画像 は イメージ です")
...
(def-easy-hint 2862061 "無下 には できない")
(def-easy-hint 2863521 "上 には 上 が いる")
(def-easy-hint 2863544 "右に出る 者 は いない")
(def-easy-hint 2863602 "余り物 には 福 が ある")
...
(def-easy-hint 2859764 "他人 の 不幸 は 蜜 の 味")
(def-easy-hint 2860668 "親 の 恩 は 子 で 送る")
(def-easy-hint 2867148 "敵 の 急所 は 我が 急所")
...
(def-easy-hint 2860665 "子 は 親 の 鏡")
(def-easy-hint 2860666 "子供 は 親 の 鏡")
(def-easy-hint 2860667 "子供 は 風 の 子")
(def-easy-hint 2860677 "兄弟 は 他人 の 始まり")
...
(def-easy-hint 2860664 "子供 は 親 の 背中 を 見て 育つ")
...
(def-easy-hint 2862433 "商人 は 損して いつか 倉 が 建つ")
(def-easy-hint 2863524 "まさか とは 思う が")
(def-easy-hint 2864960 "言い方 は 悪いです が")
...
(def-easy-hint 2868513 "人 は パン のみ にて 生くる に 非ず")
...
(def-easy-hint 2863450 "人の口 に 戸 は 立てられぬ")
(def-easy-hint 2864443 "に 至って は")
...
(def-easy-hint 2204790 "コリント人 へ の 手紙")
(def-easy-hint 2204800 "ガラテヤ人 へ の 手紙")
(def-easy-hint 2204840 "ローマ人 へ の 手紙")
(def-easy-hint 2859067 "そこ へ 行く と")
(def-easy-hint 1586550 "後 へ 引く")
